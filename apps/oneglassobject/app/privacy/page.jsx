export const metadata = {
  ...
  description: 'How One Glass Object collects, uses and protects your personal data.',
    ...
    <>
      <div style={{ paddingTop: 68, background: 'var(--cream)', minHeight: '100vh' }}>
        <div className="policy-wrap">
          ...
          <p>One Glass Object (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;) is committed to protecting your personal data. This policy explains what information we collect, how we use it, and your rights under UK GDPR and the Data Protection Act 2018.</p>

          <h2>1. Who We Are</h2>
          <p>One Glass Object is an online retailer of handcrafted mulberry silk ribbons, operating at <a href="https://oneglassobject.com">oneglassobject.com</a>. For data enquiries, contact us at <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a>.</p>
          ...
          <p>To exercise any of these rights, email <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a>. You also have the right to lodge a complaint with the <a href="https://ico.org.uk" target="_blank" rel="noopener">ICO (Information Commissioner&rsquo;s Office)</a>.</p>
