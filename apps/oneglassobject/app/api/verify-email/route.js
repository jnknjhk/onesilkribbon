...
<body><div class="wrapper">
  ...
  <div class="body">
    ...
    <a href="https://oneglassobject.com/collections" class="btn">Start Shopping</a>
  ...
  await fetch(RESEND_API, {
    ...
    body: JSON.stringify({ from: FROM, to: email, subject: `Your exclusive welcome code — One Glass Object`, html }),
  })
}
