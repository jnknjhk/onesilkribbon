export const metadata = {
  ...
  description: 'Terms and conditions for purchasing from One Glass Object.',
    ...
    <>
      <div style={{ paddingTop: 68, background: 'var(--cream)', minHeight: '100vh' }}>
        <div className="policy-wrap">
          ...
          <p>Please read these terms carefully before placing an order with One Glass Object. By purchasing from us, you agree to these terms.</p>

          <h2>1. About Us</h2>
          <p>One Glass Object is an online retailer of handcrafted silk ribbons operating at <a href="https://oneglassobject.com">oneglassobject.com</a>. For any queries, contact us at <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a>.</p>
          ...
          <p>To initiate a return, email <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a> with your order number. Return postage is at your expense unless the item is faulty or the return is due to an error on our part.</p>
          ...
          <p>All content on this website — including text, images, logos and design — is the property of One Glass Object and protected by copyright. You may not reproduce or use any content without prior written permission.</p>
