      ...
      <div style={{ maxWidth: 480, margin: '0 auto 48px', background: 'var(--sand)', padding: '36px 40px', textAlign: 'left' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <Row label="Delivery" value={
            typeof window !== 'undefined' && !['GB','IE'].includes(new URLSearchParams(window.location.search).get('country') || 'GB')
              ? '7–14 working days (International)'
              : '3–5 working days (UK Standard)'
          } />
