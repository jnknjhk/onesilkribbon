export const metadata = {
  title: 'Cookie Policy',
  description: 'How One Glass Object uses cookies on its website.',
    ...
    <>
      <div style={{ paddingTop: 68, background: 'var(--cream)', minHeight: '100vh' }}>
        <div className="policy-wrap">
          ...
          <p>This policy explains how One Glass Object uses cookies and similar technologies when you visit <a href="https://oneglassobject.com">oneglassobject.com</a>.</p>
          ...
          <h2>Contact</h2>
          <p>If you have any questions about our use of cookies, email us at <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a>.</p>
        </div>
      </div>
