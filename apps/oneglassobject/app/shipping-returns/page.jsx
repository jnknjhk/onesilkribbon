...
export const metadata = {
  ...
  description: 'Delivery options, timescales and returns policy for One Glass Object.',
    ...
    <>
      <div style={{ paddingTop: 68, background: 'var(--cream)', minHeight: '100vh' }}>
        <div className="policy-wrap">
          ...
          <p>Every order from One Glass Object is carefully prepared by hand — wrapped in tissue, rolled onto a vintage wooden spool, and sealed with our wax stamp. Here is everything you need to know about how it reaches you.</p>
          ...
          <p>Please contact us at <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a> before returning your order so that we can provide the appropriate return instructions. Refunds will be issued after the returned item has been received and inspected.</p>

          <h2>Damaged or Defective Items</h2>
          <p>If your order arrives damaged or you believe the product has a quality issue, please contact us at <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a> within 7 days of receiving your order.</p>
          <p>Please include:</p>
          <ul>
          ...
          <h2>Contact Us</h2>
          <p>If you have any questions about shipping or returns, please contact us before placing a return request. Email: <a href="mailto:hello@oneglassobject.com">hello@oneglassobject.com</a></p>
        </div>
      </div>
