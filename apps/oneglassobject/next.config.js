...
const nextConfig = {
  ...
  experimental: {
    serverActions: { allowedOrigins: ['localhost:3000', 'oneglassobject.com'] }
  },
  async redirects() {
    return [
...
// 不配置时回退到 oneglassobject
module.exports = withSentryConfig(nextConfig, {
  org:     process.env.SENTRY_ORG     || 'oneglassobject',
  project: process.env.SENTRY_PROJECT || 'oneglassobject',
  silent:  true,
