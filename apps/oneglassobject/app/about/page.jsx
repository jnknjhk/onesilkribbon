...
export const metadata = {
  title: 'Our Story',
  description: 'One Glass Object began with a simple frustration: finding a silk ribbon that felt truly beautiful. Made with carefully chosen materials, with intention.',
    ...
    <>
      <div style={{ background: 'var(--cream)' }}>
        ...
        <div style={{ position: 'relative', paddingTop: 68, height: '72vh', minHeight: 440, overflow: 'hidden' }}>
          {imgMap.about_hero ? (
            <Image src={imgMap.about_hero} alt="One Glass Object" fill priority sizes="100vw" style={{ objectFit: 'cover' }} />
          ) : (
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', maxWidth: 1360, margin: '0 auto', padding: '0 60px' }} className="about-grid">
          <div style={{ padding: '96px 80px 96px 0', borderRight: '1px solid var(--sand)' }}>
            ...
            <p style={{ fontSize: 15, fontWeight: 400, lineHeight: 2.2, color: 'var(--taupe)', marginBottom: 18 }}>
              One Glass Object began with a simple frustration: I couldn&rsquo;t find a ribbon that felt truly beautiful.
            </p>
            <p style={{ fontSize: 15, fontWeight: 400, lineHeight: 2.2, color: 'var(--taupe)', marginBottom: 18 }}>
