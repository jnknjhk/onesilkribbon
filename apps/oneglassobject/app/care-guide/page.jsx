export const metadata = {
  ...
  description: 'How to wash, iron, store and handle your handmade One Glass Object mulberry silk ribbons.',
      ...
      <div style={{ paddingTop: 68, background: 'var(--cream)', minHeight: '100vh' }}>
        ...
        <div style={{ maxWidth: 780, margin: '0 auto', padding: '56px 60px 0' }} className="care-pad">
          <p style={{ fontSize: 15, fontWeight: 400, lineHeight: 2.2, color: 'var(--taupe)' }}>
            Mulberry silk is a natural protein fibre — lustrous, strong, and responsive to how it is handled. With a little care, your ribbon will keep its sheen and softness indefinitely. These guidelines apply to all One Glass Object products.
          </p>
        </div>
