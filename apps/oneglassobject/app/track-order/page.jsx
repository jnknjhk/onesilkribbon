      ...
      <div style={{ maxWidth: 640, margin: '0 auto', padding: '40px 40px 100px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 60 }}>
          ...
          <p style={{ fontSize: 15, fontWeight: 400, color: 'var(--taupe)', lineHeight: 1.9 }}>
            ...
            Your order number can be found in your confirmation email (e.g. OGO-2026-0001).
          </p>
        </div>
        ...
        <form onSubmit={handleTrack} style={{ display: 'flex', gap: 0, marginBottom: 48 }}>
          <input
            ...
            placeholder="Your order number (e.g. OGO-2026-0001)"
        ...
        <div style={{ marginTop: 48, textAlign: 'center', padding: '28px', background: 'var(--mist)', borderTop: '1px solid var(--sand)' }}>
          <p style={{ fontSize: 14, fontWeight: 400, color: 'var(--taupe)', lineHeight: 1.9 }}>
            Can&apos;t find your order? <a href="mailto:orders@oneglassobject.com" style={{ color: 'var(--gold)' }}>Contact us</a> and we&apos;ll help you track it down.
          </p>
        </div>
      </div>
    </div>
